...
import 'package:prohealth360_daktari/application/redux/actions/communities/fetch_media_action.dart';
import 'package:prohealth360_daktari/application/redux/states/app_state.dart';
import 'package:prohealth360_daktari/application/redux/view_models/communities/media_item_view_model.dart';
      ...
      onLongPress: () {
        ScaffoldMessenger.of(context)
          ...
          ..showSnackBar(
            const SnackBar(
              content:
                  Text(optionsToBeAvailableSoonString),
            ),
          );
      },
      child: Column(
                  ...
                  builder: (BuildContext context, MediaItemViewModel vm) {
                    ...
                    if (imageByteMap?.isNotEmpty ?? false) {
                      ...
                      if (bodyBytes != null && bodyBytes.isNotEmpty) {
                        return Image(image: MemoryImage(bodyBytes));
                      }
