...
import 'package:prohealth360_daktari/application/redux/actions/communities/create_room_action.dart';
import 'package:prohealth360_daktari/application/redux/states/app_state.dart';
import 'package:prohealth360_daktari/application/redux/view_models/communities/create_room_view_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          const Text(welcomeAndEnterYourRoomDetailsString),
          const SizedBox(height: 20),
          TextField(
            key: nameInputKey,
            decoration: InputDecoration(
              labelText: nameString,
              hintText: enterNameString,
          ...
          TextField(
            key: topicInputKey,
            decoration: InputDecoration(
              labelText: topicString,
              hintText: enterTopicString,
              contentPadding: const EdgeInsets.only(left: 20, bottom: 32),
              focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: Theme.of(context).primaryColor,
          ...
          StoreConnector<AppState, CreateRoomViewModel>(
            ...
            builder: (BuildContext context, CreateRoomViewModel vm) {
              ...
              return TextButton(
                ...
                child: const Text(createRoomString),
              );
            },
          ),
        ],
