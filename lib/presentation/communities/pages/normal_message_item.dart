...
import 'package:prohealth360_daktari/application/redux/view_models/communities/message_options_view_model.dart';
            ...
            return StoreConnector<AppState, MessageOptionsViewModel>(
              ...
              builder: (BuildContext context, MessageOptionsViewModel vm) =>
                ...
                child: ListView(
                  shrinkWrap: true,
                  children: <Widget>[
                    const Text(messageOptionsString, style: titleStyle),
                    const SizedBox(height: 10),
                    MessageReactionItem(
                      title: replyInThreadString,
                      onTap: () {},
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                title,
                style: coloredBodyStyle(textColor),
              ),
            ),
          ],
        ),
