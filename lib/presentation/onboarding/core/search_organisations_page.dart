...
import 'package:prohealth360_daktari/application/redux/actions/search_organisation_action.dart';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      StoreProvider.dispatch(
        ...
        SearchOrganisationAction(
          ...
          searchParam: organisationSearchCode,
        ),
      );
    });
  }
    ...
    return Scaffold(
      ...
      body: StoreConnector<AppState, AppStateViewModel>(
        ...
        builder: (BuildContext context, AppStateViewModel vm) {
          if ((vm.state.wait?.isWaitingFor(fetchOrganisationsFlag) ?? false) ||
              (vm.state.wait?.isWaitingFor(fetchOrganisationsFlag) ?? false)) {
            return Container(
              height: 300,
          ...
          final List<Organisation> organisations =
              vm.state.onboardingState?.organisations ?? <Organisation>[];
          ...
          return Column(
            children: <Widget>[
              ...
              if (organisations.isNotEmpty &&
                  !vm.state.wait!.isWaitingFor(fetchOrganisationsFlag))
                Align(
