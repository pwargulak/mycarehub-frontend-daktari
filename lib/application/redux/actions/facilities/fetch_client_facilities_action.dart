...
class FetchClientFacilitiesAction extends ReduxAction<AppState> {
  ...
  Future<AppState?> reduce() async {
    ...
    final Response response =
        await client.query(getClientFacilitiesQuery, variables);
    ...
    if (processedResponse.ok) {
      ...
      if (errors != null) {
        reportErrorToSentry(
          ...
          query: getClientFacilitiesQuery,
          variables: variables,
          response: response,
          state: state,
          exception: errors,
        ...
        onFailure?.call(getErrorMessage('facilities linked to this client'));
        return null;
      }
      ...
      final List<Facility> linkedFacilities =
          getFacilitiesResponse.clientLinkedFacilities?.facilities ??
              <Facility>[];
      ...
      Sentry.captureException(
        UserException(
          ...
          cause: getClientFacilitiesQuery,
        ),
      );
    }
    return null;
