...
`UoNAfyaApp360 Daktari` is an open source project &mdash; it's one among many other shared libraries and applications that make up the wider ecosystem of software made and open sourced by `Savannah Informatics Limited`.
When you initially consider contributing to `UoNAfyaApp360 Daktari`, you might be unsure about which of those repositories implements the functionality you want to change or report a bug for. This section should help you with that.
...
This section guides you through submitting a bug report for `UoNAfyaApp360 Daktari`. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer:, and find related reports :mag_right:.
...
`UoNAfyaApp360 Daktari` and all packages can be developed locally. For instructions on how to do this, (develop, test & deploy) see the project's readme file
...
```dart
docs: UoNAfyaApp360 Daktari commit message convention
```
...
```dart
docs: add UoNAfyaApp360 Daktari convention to readme
